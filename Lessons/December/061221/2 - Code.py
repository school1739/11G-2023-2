...
b=0
for i in range (5):
    print(a[b][3],a[b][9:13],a[b][5:14:2],a[b][7:13][::-1],a[b][16:21][::-1])
    b=b+1

# Evaluation: NOT OK. Что это за дичь?
# в щ3ст фпщсм тс3щ6п амнтл
# е бане 6цбн4 енаб2ц 3б4ь4
# п н3и2 веник 2и3н1е ч21ыл
# ф ород уеоот дороже уб686
# 5 2лят мг2яь тял2щг денег