...
print("Три песни звучат " + str((round(violator_songs[3][1] + violator_songs[5][1] + violator_songs[8][1], 2))) + " минут")
...
print("А другие три песни звучат приблизительно " + str(round(pocket_universe_songs["On Track"] + pocket_universe_songs['To the Sea'] + pocket_universe_songs['Beyond Mirrors'])) + " минут")
