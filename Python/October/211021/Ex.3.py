...
# Evaluation: OK. Когда пользователя одновременно просят ввести два значения, скорее всего, он напишет через пробел,
# и в данном случае программа не сработает как надо. Лучше бы просить вводить числа по отдельности, подсказки
# записывая прямо в input().