...
spisok=["Бабушка","Дедушка","Волк","Медведь","Лиса"]
print("Введите имя зверя из списка",spisok)
spisoka=["Бабушки","Дедушки","Волка","Медведя","Лисы"]
a=input()
b=0
...
def function(b):
    ...
    for j in range(b):
        c=str(c)+spisoka[j]+","+" "
    return c
print("Я убежал от",function(b)+"и от тебя,",spisok[b]+", убегу!")

# NOT OK. Зачем пользователю вводить что-то из уже существующего списка?
# Это должно быть отдельное животное, которое идёт после всех, которые
# уже есть в списке.