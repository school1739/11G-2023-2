...
def ex(an):
    print("Я колобок, колобок")   #повторение
    print("Я от бабушки ушел")   #повторение
    print("Я от дедушки ушел")   #повторение
    for i in l:
        print(i)
    print("И от тебя ," + str(an) + ", убегу")    #тут уже повторение повторения
