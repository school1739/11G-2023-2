...
#Думаю тут даже аргументы не нужны ^^

# +-OK. Аргументы-то не нужны, а вот округлить деньги до копеек стоило бы:
# Введите количество заказов: 12
# Сумма доставки: 3255.0000000000005