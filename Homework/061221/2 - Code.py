...
#   слова, идущее в обратном порядке, нужно получить за 1 срез
#   (используя отрицательный шаг)
#   Если нужны вычисления и разные пробы - делайте это в консоли пайтона,
#   тут нужен только результат

# Расшифровываем слова сообщения используя ключ к расшифровке и срезы
# Получаем срезы
